                ...
                <div class="row">
                    <div class="col-lg-8 pl-lg-0">
                        <div class="card card-details">
                            ...
                            <div class="attendee">
                                <table class="table table-responsive-sm txt-center">
                                    <thead>
                                        <tr>
                                            <td>Picture</td>
                                            <td>Name</td>
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline">
                                    ...
                                    <select name="inputVisas" id="inputVisa" class="custom-select mb-2 mr-sm-2">
                        ...
                        <div class="card card-details card-right">
                            ...
                            <table class="trip-informations">
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="text-right text-total"><span class="text-blue">$
                                            279,</span><span class="text-orange">33</span>
                                    </td>
                                </tr>
                            </table>
                            <hr />
    ...
    <script>
        $(document).ready(function () {
            $('.datepicker').datepicker({
                ...
                icons: {
                    rightIcon: '<img src="frontend/images/Tanggal.png"/>'
                }
            })
        });
