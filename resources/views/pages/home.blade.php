...
@section('content')
 ...
 <!-- Header -->
    <header class="text-center">
        <h1>Explore The Beauty World<br>As Easy One Click</h1>
        <p>
            You will see beautiful
            <br>
            moment you never see before
        </p>
        <a href="{{ url('detail')}}" class="btn btn-get-started px-4 mt-4">
            Get Started
        </a>
    </header>
    ...
    <main>
        ...
        <section class="section-testimonials-heading" id="testimonials">
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                <div class="section-popular-travel row justify-content-center">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="frontend/images/testimoni1.png" alt="User" class="mb-4 rounded-circle">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="frontend/images/testimoni2.png" alt="User" class="mb-4 rounded-circle">
                                <h3 class="mb-4">Luna Mumtaza</h3>
                                <p class="testimonials">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="frontend/images/testimoni3.png" alt="User" class="mb-4 rounded-circle">
                                <h3 class="mb-4">Alynaa Shabrina</h3>
                                <p class="testimonials">
